...
class scholar extends searchType {
    constructor() {
        super();
        this._name = "Scholar";
        this._icon = "scholar.svg";
    }

    query(s) {
        let q = encodeURIComponent(s);
        let url = "https://scholar.google.com/scholar?hl=en&as_sdt=0%252C5&q=" + q;
        window.open(url, "_self");
    }
}

class wolframalpha extends searchType {
    constructor() {
        super();
        this._name = "wolframalpha";
        this._icon = "wolframalpha.svg"
    }

    query(s) {
        let q = encodeURIComponent(s);
        let url = "https://www.wolframalpha.com/input?i=" + q;
        window.open(url, "_self");
    }
...
function setDropdown() {
    let dropdownValues = [new google(), new bing(), new scholar(), new wolframalpha(), new youtube(), new browse()]
